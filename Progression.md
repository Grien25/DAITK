...
- Launch the GUI with `python3 scripts/function_browser.py` to browse the `asm/` folder. Select a file to view its functions in a second table and double-click a function to open the assembly.
